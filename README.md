...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/p11-kit-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/p11-kit-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
It is possible to list all of the versions of `p11-kit` available on your platform:
...
```
pixi search p11-kit --channel conda-forge
```
